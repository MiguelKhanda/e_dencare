...
const Individual = () => {
  return (
    <div className='flex flex-col w-[95%] mx-auto'>
        <h1 className='text-primary text-center pb-8'>Meet the team</h1>
        {data.map((data)=>(
            <div className='flex mb-20' key={data.id}>
                <div className='w-1/2 bg-linear-to-r  from-secondary to-primary text-transparent bg-clip-text text-xs'>
