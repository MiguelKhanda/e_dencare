...
const Navbar = () => {
  ...
  return (
    <ToggleContext value = {[isClicked, setIsClicked]}>
      <nav className='absolute flex w-full bg-primary items-center justify-between sm  px-3 py-0 backdrop-blur-md opacity-70 top-0 left-0 border-b-2 border-accent z-50'>
          <Image
              src='/images/logo.png'
              alt='EdenCare logo'
              width={60}
